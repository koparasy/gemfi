...
<<<<<<< HEAD
  ('file -> opt_rom_or_macros','file',1,'p_file','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',311),
  ('opt_rom_or_macros -> <empty>','opt_rom_or_macros',0,'p_opt_rom_or_macros_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',314),
  ('opt_rom_or_macros -> rom_or_macros','opt_rom_or_macros',1,'p_opt_rom_or_macros_1','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',317),
  ('rom_or_macros -> rom_or_macro','rom_or_macros',1,'p_rom_or_macros_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',320),
  ('rom_or_macros -> rom_or_macros rom_or_macro','rom_or_macros',2,'p_rom_or_macros_1','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',323),
  ('rom_or_macro -> rom_block','rom_or_macro',1,'p_rom_or_macro_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',326),
  ('rom_or_macro -> macroop_def','rom_or_macro',1,'p_rom_or_macro_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',327),
  ('rom_block -> DEF ROM block SEMI','rom_block',4,'p_rom_block','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',331),
  ('macroop_def -> DEF MACROOP ID LPAREN ID RPAREN SEMI','macroop_def',7,'p_macroop_def_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',341),
  ('macroop_def -> DEF MACROOP ID block SEMI','macroop_def',5,'p_macroop_def_1','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',351),
  ('block -> LBRACE statements RBRACE','block',3,'p_block','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',363),
  ('statements -> statement','statements',1,'p_statements_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',369),
  ('statements -> statements statement','statements',2,'p_statements_1','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',376),
  ('statement -> content_of_statement end_of_statement','statement',2,'p_statement','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',382),
  ('content_of_statement -> microop','content_of_statement',1,'p_content_of_statement_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',387),
  ('content_of_statement -> directive','content_of_statement',1,'p_content_of_statement_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',388),
  ('content_of_statement -> <empty>','content_of_statement',0,'p_content_of_statement_1','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',393),
  ('end_of_statement -> NEWLINE','end_of_statement',1,'p_end_of_statement','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',398),
  ('end_of_statement -> SEMI','end_of_statement',1,'p_end_of_statement','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',399),
  ('microop -> labels ID','microop',2,'p_microop_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',404),
  ('microop -> ID','microop',1,'p_microop_1','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',411),
  ('microop -> labels ID PARAMS','microop',3,'p_microop_2','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',417),
  ('microop -> ID PARAMS','microop',2,'p_microop_3','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',425),
  ('labels -> label','labels',1,'p_labels_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',433),
  ('labels -> labels label','labels',2,'p_labels_1','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',437),
  ('labels -> labels NEWLINE','labels',2,'p_labels_2','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',443),
  ('label -> ID COLON','label',2,'p_label_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',447),
  ('label -> EXTERN ID COLON','label',3,'p_label_1','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',454),
  ('directive -> DOT ID','directive',2,'p_directive_0','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',462),
  ('directive -> DOT ID PARAMS','directive',3,'p_directive_1','/home/koparasy/Developing/gem5/src/arch/micro_asm.py',468),
=======
...
>>>>>>> 59d98fe4ca9560cdb4b909b74f8caf86e103390d
]
